function [akar, iter_table] = bisection(f, a, b, tol, max_iter)
% =========================================================
%  BISECTION  --  Metode Bagi Dua (Bisection Method)
% =========================================================
...
%  CONTOH PENGGUNAAN:
%    f = @(x) x.^3 - x - 2;
%    [akar, tabel] = bisection(f, 1, 2, 1e-6, 50);
%
