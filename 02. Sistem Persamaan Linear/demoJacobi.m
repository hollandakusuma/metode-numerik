...
fprintf('\n');
fprintf('*****************************************************\n');
fprintf('*      DEMO PROGRAM: ITERASI JACOBI                *\n');
fprintf('*****************************************************\n\n');
...
[x1, tabel1, ok1] = jacobiIteration(A1, b1, x01, 1e-6, 50);
...
[x2, tabel2, ok2] = jacobiIteration(A2, b2, x02, 1e-6, 50);


% =========================================================
% KASUS 3: Sistem 2x2 — tidak dominan diagonal
%   x1 + 4x2 = 5   (|1| < |4|  --> tidak dominan)
%   4x1 + x2 = 5
%  Jacobi mungkin tidak konvergen dari x0 = [0;0]
% =========================================================
fprintf('\n>>> KASUS 3: Sistem 2x2 (TIDAK dominan diagonal)\n');
fprintf('    x1 + 4x2 = 5\n');
fprintf('   4x1 +  x2 = 5\n\n');
...
[x3, tabel3, ok3] = jacobiIteration(A3, b3, x03, 1e-6, 20);
